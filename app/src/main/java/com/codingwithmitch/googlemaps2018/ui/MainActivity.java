...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // firebasefirestore Server intialize
    ...
    private boolean isLocationServiceRunning() {
            ...
            for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)){
                if("com.codingwithmitch.googlemaps2018.services.LocationService".equals(service.service.getClassName())) {
    ...
    private void saveUserLocation(){
        if(mUserLocation != null){
            DocumentReference sen = mDb
                    .collection(getString(R.string.collection_user_locations))
                    .document(FirebaseAuth.getInstance().getUid());
            sen.set(mUserLocation).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
